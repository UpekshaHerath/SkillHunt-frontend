  ...
  export const jobs: Job[] = [
    {
      ...
      description: "We are seeking a talented Frontend Developer to join our dynamic team...",
      requirements: [
    ...
    },
    {
      ...
      description: "We're looking for a skilled DevOps Engineer to help us scale our cloud infrastructure...",
      requirements: [
    ...
    },
    {
      ...
      description: "Join our mobile development team to create innovative iOS applications...",
      requirements: [
    ...
    },
    {
      ...
      description: "We are seeking a skilled Cybersecurity Analyst to protect our systems and data...",
      requirements: [
